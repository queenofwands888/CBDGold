...
import type { StakingPool } from '../../data/constants';
...
const StakingSection: React.FC<StakingSectionProps> = ({ walletConnected, hempBalance, onStake, onUnstake, onTxStatus }) => {
  ...
  const tx = await stakeHemp(); // simulate immediate return
      onTxStatus?.('confirmed', tx.txId);
