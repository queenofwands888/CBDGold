...
import type { GovernanceProposal } from '../../data/constants';
...
const GovernanceSection: React.FC<GovernanceSectionProps> = ({ walletConnected, weedBalance, onVote, onTxStatus }) => {
