...
import { claimPrize as claimPrizeContract } from '../contracts/client/prizeClient';
import type { PrizeTxResult } from '../contracts/client/prizeClient';
...
const ClaimPrize: React.FC<ClaimPrizeProps> = ({ userAddress, prizeId, onClaimed, onTxStatus }) => {
  // const wallet = useWallet(); // Remove unused variable
  ...
  const tx: PrizeTxResult = await claimPrizeContract();
